...
- Core taxonomic data are exported to and available at the [Catalogue of Life](https://www.catalogueoflife.org/data/taxon/B7VSN) and its [associated API](https://api.checklistbank.org/dataset/3LR/taxon/B7VSN).
